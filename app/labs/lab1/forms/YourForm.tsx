    ...
    return (
      <div>
        ...
        <form id="wd-your-form">
          ...
          <input type="password" id="wd-your-student-id" defaultValue="00000000" />
          <br />
          ...
          <textarea
            ...
            cols={40}
            rows={5}
            defaultValue="SAMPLE - replace with why you are taking this course."
          />
          <br />
          ...
          <br />
          <input type="checkbox" name="your-interests" id="wd-your-int-web" />
          ...
          <input
            type="email"
            id="wd-your-email"
            placeholder="SAMPLE - your NEU email"
          />
          <br />
