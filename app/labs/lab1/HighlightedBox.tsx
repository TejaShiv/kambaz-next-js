  ...
  return (
    <div id="wd-highlighted-box">
      ...
      >
        ...
        <ul>
          <li>Get properly comfortable with JavaScript</li>
          <li>Build and ship a full stack application end to end</li>
          <li>Finish the study-layer feature for the final project</li>
        </ul>
      </HighlightedBox>
